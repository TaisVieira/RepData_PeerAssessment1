...
plot(interval_avg, type="l", main="Averge number of steps taken per interval", xlab="Interval", ylab="Number of steps")
...
abline(v=mean(day_total$sum), col="red", lwd=2)
abline(v=median(day_total$sum), col="blue", lwd=2)
legend("topright", c("mean: 9354", "median: 10395"), col=c("red", "blue"), lwd=2, cex = 0.7)
...
legend("topright", c("mean: 9504", "median: 10395"), col=c("red", "blue"), lwd=2, cex = 0.7)   #the mean changed slightly, the median remained the same


#Are there differences in activity patterns between weekdays and weekends?
data_replaced$weekday<-weekdays(data_replaced$weekday)
